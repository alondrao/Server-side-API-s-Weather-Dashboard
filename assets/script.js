...
var getCurrentConditions = (event) => {
    ...
    .then((response) => {
       ...
       // Get the current time and timezone offset
...
var getFiveDayForecast = (event) => {
    ...
    fetch(queryURL)
       ...
       // Loop through the response list to get the forecast for the next five days
        for (let i = 0; i < response.list.length; i++) {
            ...
            // Display the forecast at 11:00:00, 12:00:00, and 13:00:00
...
var renderCities = () => {
    ...
    if (localStorage.length===0){
        if (lastCity){
            ...
            $('#search-city').attr("value", "Annandale");
        }
    } else {
